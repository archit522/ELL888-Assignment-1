...
class NeuralNet:
	...
	def divide_and_learn(self, training_set, batch_size, eta, epochs, lmbda, num_iter, cost_function, test_data = None, L1_Reg = False, L2_Reg = False, dropout = 0.0, batch_norm = 0):
		...
		for j in xrange(epochs):			
			...
			for batch in batches:
				self.learn_NN(batch, eta, batch_size, lmbda, L1_Reg, L2_Reg, dropout, batch_norm)
	...
	def learn_NN(self, X, eta, batch_size, lmbda, cost_function, L1_Reg = False, L2_Reg = False, dropout = 0.0, batch_norm = 0):
		...
		batch_X = np.concatenate([arr for arr in X])
...
net = NeuralNet([784, 60, 6])
net.divide_and_learn(training_data, 16, 0.01, 40, 10, 1, 1, test_data = test_data, L1_Reg = False, L2_Reg = False, dropout = 0.0, batch_norm = 1)
